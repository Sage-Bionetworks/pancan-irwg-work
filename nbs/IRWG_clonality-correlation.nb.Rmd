...
gplots::heatmap.2(clonality_ciber_frac_corr_mat,
                  ...
                  col = my_cet_pal,
                  cellnote = clonality_ciber_frac_padj_mat, notecol = "white",
                  ColSideColors = col_colors$Color,
                  RowSideColors = row_colors$Color,
                  lmat = lmat, lwid = lwid, lhei = lhei, margins = c(4, 12),
                  key.title = NA, key.xlab = "ITH correlation",
                  key.par = list(mgp = c(1.5, 0.5, 0),
                                 mar = c(3, 3, 3, 1)))

# legend(1, 0,
#        legend = c("Total leukocyte correlation adjusted P < 0.05", 
#                   "Total leukocyte adjusted P > 0.05"),
#        col = c("#56B4E9", "#999999"),
#        horiz = FALSE, xjust = 1, yjust = 0,
#        lty = 10, lwd = 8, cex = 0.7)
# legend(0.5, 0,
...
png("figures/clonality_immunomod_corr.png",
    width = 8*300, height = 8*300, res = 300, pointsize = 8)
...
gplots::heatmap.2(clonality_mrna_corr_mat,
                  ...
                  col = my_cet_pal,
                  cellnote = clonality_mrna_padj_mat, notecol = "white",
                  RowSideColors = row_colors$Color,
...
legend(-0.05, -0.1,
       legend = distinct(row_colors, group, Color)$group,
       col = distinct(row_colors, group, Color)$Color,
       horiz = FALSE, xjust = 0, yjust = 0, ncol = 2,
       lty = 1, lwd = 7, cex = 0.6, seg.len = 0.8)
```
