...
```{r}
immunomod_subtype_expr_df <- immunomod_zscore_df %>% 
...
p_expr <- immunomod_subtype_expr_df %>% 
    ...
    ggplot2::theme(axis.text.x = ggplot2::element_blank(),
          ...
          panel.spacing.y = ggplot2::unit(1, "points"),
          panel.spacing.x = ggplot2::unit(1, "points"),
          legend.position = "right",
          legend.title = ggplot2::element_text(size = 8))
p_annot <- immunomod_subtype_expr_df %>% 
    ...
    ggplot2::theme(axis.text.x = ggplot2::element_blank(),
          ...
          legend.position = "top",
          legend.title = ggplot2::element_text(size = 8))
p_annot + p_expr + patchwork::plot_layout(nrow = 1, widths = c(1, 12))
```
